...
다음 변경은 기존 사용자 작업이므로 임의로 스테이징하거나 삭제하지 않는다.

- 수정: `tools/test_inventory_outfit_rules.mjs`
- 미추적: `assets/characters/seonhwa/wardrobe-v2/`
- 미추적: `assets/schedule-layers-v2/childcare/hero-actions/chase-running-v4/`
