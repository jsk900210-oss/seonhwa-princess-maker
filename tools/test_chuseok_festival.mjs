...
assert.ok(fs.existsSync(new URL('../assets/characters/seonhwa/dialogue/age-13-determined-lowbraid-dialogue-v1.png',import.meta.url)),'현재 13세 분노 상태 대답은 상반신 낮은 땋은머리 초상을 사용해야 합니다.');
assert.match(app,/'13':\['nervous','determined'\]/,'13세의 긴장·부끄러움·분노 대답은 전신 폴백으로 빠지면 안 됩니다.');
