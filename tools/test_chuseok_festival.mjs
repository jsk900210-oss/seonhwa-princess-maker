...
assert.equal((beats.match(/'[^']+'/g)||[]).length,19,'경연은 우승자 인터뷰를 포함한 19개 이야기 비트여야 합니다.');
...
assert.match(app,/moonlightMotionNames=\['opening-dialogue','opening-dialogue','prepare'/,'첫 두 장면은 신수와 선화의 교대 대화여야 합니다.');
