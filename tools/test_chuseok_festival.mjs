...
for(const asset of ['app.js','style.css','schedule.css'])assert.ok(html.includes(`${asset}?v=0.64.199-debug`),`${asset} 캐시 키가 표시 버전과 같아야 합니다.`);
...
assert.match(app,/\[1,2,3,4,3,2,1\]/,'선화 수상 인사는 실제 이미지 7단계 왕복 프레임이어야 합니다.');
assert.match(app,/acceptance-v6\/seonhwa-acceptance-/,'선화 수상 인사는 신규 고해상도 투명 프레임을 사용해야 합니다.');
