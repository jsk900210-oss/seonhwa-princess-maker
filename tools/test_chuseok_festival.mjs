...
assert.match(css,/명절 이벤트 대화는 조작 버튼 아래의 중앙 84% 폭으로 통일한다[\s\S]*?left:8%!important[\s\S]*?right:8%!important[\s\S]*?top:10%!important/,'이벤트 대화창은 중앙 비율을 유지하면서 설정·배속 버튼과 겹치지 않아야 합니다.');
