...
assert.match(app,/applyRelationPortrait\(male,candidate,episode\)/,'첫 대화부터 회차 감정에 맞는 남자 주인공 상반신 포즈를 사용해야 합니다.');
assert.match(app,/male\.src=relationDialoguePosePath\(candidate,episode,choice\.emotion\)/,'선택 결과 뒤에도 답변 감정에 맞는 남자 주인공 상반신 포즈를 유지해야 합니다.');
