...
if(!app.includes('Math.random()<.08'))throw new Error('방문상점 8% 무작위 방문 확률 누락');
...
if(!app.includes("errand:'errand'")||!app.includes('return unifiedFrames(canonicalActivityAliases[activity]'))throw new Error('장터 심부름 연령별 기준 프레임 연결 누락');
