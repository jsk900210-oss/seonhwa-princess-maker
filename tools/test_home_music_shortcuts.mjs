...
assert.ok(app.includes("phaseRecords.every(record=>record.action?.id==='vacation')&&index<selected.length-1")&&app.includes('if(!vacationContinuesToNextSchedule)await showPhaseReport'),'다음 일정이 있는 바캉스 종료 뒤 페이즈 결과 대기가 남아 있습니다.');
