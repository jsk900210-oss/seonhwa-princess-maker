...
for(const activityId of ['kitchenhelp','childcare','painting','music','dance','sewing','copying','woodwork']){
...
assert.ok(app.includes("const scheduleLayerV2PilotIds=new Set(['kitchenhelp','childcare','painting','music','dance','sewing','copying','woodwork'])"),'v2 일정 8종이 모두 필요합니다.');
...
console.log('PASS: 일정 v2 8종, QA 패턴, 선화 고정 크기');
