...
assert.ok(app.includes("freeTimeVariant?.activity||'errand'")&&app.includes("stageCharacter.style.removeProperty('left')")&&app.includes("stageCharacterImage.style.removeProperty('transform')"),'자유행동이 끝나면 캐릭터 위치와 방향을 복구하고 다음 활동으로 진행해야 합니다.');
