...
assert.match(app,/if\(kind==='drawing'\)return `\$\{scheduleFramePath\(`calligraphy-pixel-\$\{frame\}\.png`\)\}\?v=\$\{scheduleAssetRevision\}`;/,'세화 붓질 장면의 선화는 일정 화면과 같은 쯔꾸르 픽셀 프레임을 사용해야 합니다.');
